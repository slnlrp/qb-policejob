...
Config.Locations = {
    ["duty"] = {
        [1] = vector3(441.22, -982.18, 30.69),
        [2] = vector3(-449.811, 6012.909, 31.815)
    },
    ["vehicle"] = {
        [1] = vector4(452.48, -980.78, 25.7, 170.77), -- MRPD
        [2] = vector4(431.23, -979.9, 25.7, 172.33), -- MRPD
        [3] = vector4(-455.39, 6002.02, 31.34, 87.93)
    },
    ["stash"] = {
        [1] = vector3(461.86, -995.96, 30.69)
    },
    ["impound"] = {
        [1] = vector4(477.62, -1023.19, 28.04, 272.37),
        [2] = vector4(-436.14, 5982.63, 31.34, 136.0)
    },
    ["helicopter"] = {
        [1] = vector4(449.7, -981.56, 43.69, 77.94),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34)
    },
    ["armory"] = {
        [1] = vector3(479.13, -996.86, 30.69)
    },
    ["trash"] = {
        [1] = vector3(451.66, -998.83, 30.69)
    },
    ["fingerprint"] = {
        [1] = vector3(474.43, -1013.4, 26.27)
    },
    ["evidence"] = {
        [1] = vector3(480.91, -984.6, 30.69),
        [2] = vector3(446.95, -997.23, 30.69),
        [3] = vector3(475.1, -996.26, 26.27)
    },
    ["stations"] = {
        [1] = {
            label = "NLPD - Headquartes",
...
Config.SecurityCameras = {
    ...
    cameras = {
        ...
        [8] = {
            ...
            coords = vector3(23.885, -1342.441, 31.672),
            r = {
                x = -35.0,
                y = 0.0,
                z = -142.9191
        ...
        [11] = {
            ...
            coords = vector3(383.402, 328.915, 105.541),
            r = {
                x = -35.0,
                y = 0.0,
                z = 118.585
        ...
        [14] = {
            ...
            coords = vector3(-3046.749, 592.491, 9.808),
            r = {
                x = -35.0,
                y = 0.0,
                z = -116.673
        ...
        [15] = {
            ...
            coords = vector3(-3246.489, 1010.408, 14.705),
            r = {
                x = -35.0,
                y = 0.0,
                z = -135.2151
        ...
        [16] = {
            ...
            coords = vector3(539.773, 2664.904, 44.056),
            r = {
                x = -35.0,
                y = 0.0,
                z = -42.947
        ...
        [18] = {
            ...
            coords = vector3(2673.579, 3281.265, 57.541),
            r = {
                x = -35.0,
                y = 0.0,
                z = -80.242
        ...
        [19] = {
            ...
            coords = vector3(1966.24, 3749.545, 34.143),
            r = {
                x = -35.0,
                y = 0.0,
                z = 163.065
        ...
        [20] = {
            ...
            coords = vector3(1729.522, 6419.87, 37.262),
            r = {
                x = -35.0,
                y = 0.0,
                z = -160.089
...
Config.AuthorizedVehicles = {
    ...
    [7] = {
        ...
        ["c8p"] = "Police Highspeed Covertte",
        ["pbus"] = "Police Prison Bus",
        ["HellcatRed"] = "Police Chief Cruiser"
	},
...
Config.Radars = {vector4(-623.44421386719, -823.08361816406, 25.25704574585, 145.0),
                 ...
                 vector4(657.315, -218.819, 44.06, 320.0), vector4(2118.287, 6040.027, 50.928, 172.0),
                 vector4(-106.304, -1127.5530, 30.778, 230.0), vector4(-823.3688, -1146.980, 8.0, 300.0)}
